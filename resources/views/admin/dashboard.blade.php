                ...
                <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                  <div>
                    <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                        <svg class="icon">
                          <use xlink:href="/tamplate/vendors/@coreui/icons/svg/free.svg#cil-arrow-bottom"></use>
                        </svg>)</span></div>
                    <div>Users</div>
                  </div>
                  <div class="dropdown">
                    <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <svg class="icon">
                        <use xlink:href="/tamplate/vendors/@coreui/icons/svg/free.svg#cil-options"></use>
                      </svg>
                    </button>
...
{{-- statistik --}}
 ...
 <h1 class="text-2xl font-bold text-800 mb-6">📊 Dashboard Statistik Pengunjung</h1>

        <!-- === Kartu Statistik === -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            <div class="bg-blue-600 text-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center">
                <h2 class="text-lg font-semibold">Pengunjung Hari Ini</h2>
                <p class="text-4xl font-bold mt-2">{{ $today }}</p>
            </div>

            <div class="bg-green-500 text-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center">
                <h2 class="text-lg font-semibold">Pengunjung Bulan Ini</h2>
                <p class="text-4xl font-bold mt-2">{{ $month }}</p>
            </div>

            <div class="bg-purple-600 text-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-center">
                <h2 class="text-lg font-semibold">Total Pengunjung</h2>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
    ...
    <div class="bg-white shadow-lg rounded-xl p-5">
        <h3 class="text-lg font-semibold text-gray-700 mb-4">Kunjungan Harian (7 Hari Terakhir)</h3>
        <div class="h-80">
    ...
    <div class="bg-white shadow-lg rounded-xl p-5">
        <h3 class="text-lg font-semibold text-gray-700 mb-4">Kunjungan Bulanan (12 Bulan Terakhir)</h3>
        <div class="h-80">
...
<script>
    function getChartColors() {
        ...
        return {
            ...
            barColor: isDark ? 'rgba(96, 165, 250, 0.8)' : 'rgba(37, 99, 235, 0.7)',
            barBorder: isDark ? 'rgba(147, 197, 253, 1)' : 'rgba(37, 99, 235, 1)',
            lineColor: isDark ? 'rgba(74, 222, 128, 1)' : 'rgba(16, 185, 129, 1)',
            lineFill: isDark ? 'rgba(74, 222, 128, 0.2)' : 'rgba(16, 185, 129, 0.3)'
        };
    }
        ...
        options: {
            ...
            scales: {
                y: {
                    ...
                    title: { display: true, text: 'Kunjungan', color: colors.textColor }
                },
                x: {
                    ticks: { color: colors.textColor },
                    grid: { color: colors.gridColor },
                    title: { display: true, text: 'Tanggal', color: colors.textColor }
                }
            },
            plugins: {
    ...
    const monthlyChart = new Chart(ctx2, {
        type: 'line',
        data: {
            labels: {!! json_encode(array_keys($last12Months)) !!},
            datasets: [{
                label: 'Jumlah Kunjungan Bulanan',
                data: {!! json_encode(array_values($last12Months)) !!},
        ...
        options: {
            ...
            scales: {
                ...
                x: {
                    ticks: { color: colors.textColor },
                    grid: { color: colors.gridColor },
                    title: { display: true, text: 'Bulan', color: colors.textColor }
                }
            },
            plugins: {
                legend: { labels: { color: colors.textColor } }
    ...
    // === PERBAIKAN: deteksi perubahan tema Tailwind ===
    const observer = new MutationObserver(() => {
        const newColors = getChartColors();

        [dailyChart, monthlyChart].forEach(chart => {
            ...
            if (chart.config.type === 'bar') {
                chart.data.datasets[0].backgroundColor = newColors.barColor;
                chart.data.datasets[0].borderColor = newColors.barBorder;
            } else {
                chart.data.datasets[0].borderColor = newColors.lineColor;
                chart.data.datasets[0].backgroundColor = newColors.lineFill;
                chart.data.datasets[0].pointBackgroundColor = newColors.lineColor;
            }
    ...
    // Deteksi langsung ke <html> dan <body>
                ...
                <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                  <div>
                    <div class="fs-4 fw-semibold">$6.200 <span class="fs-6 fw-normal">(40.9%
                        <svg class="icon">
                          <use xlink:href="/tamplate/vendors/@coreui/icons/svg/free.svg#cil-arrow-top"></use>
                        </svg>)</span></div>
                    <div>Income</div>
                  </div>
                  <div class="dropdown">
              ...
              <div class="d-flex justify-content-between">
                ...
                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                  ...
                  <button class="btn btn-primary" type="button">
                    <svg class="icon">
                      <use xlink:href="/tamplate/vendors/@coreui/icons/svg/free.svg#cil-cloud-download"></use>
                    </svg>
                  </button>
                </div>
              </div>
          ...
          {{-- <div class="row g-4 mb-4">
              ...
              <div class="card" style="--cui-card-cap-bg: #3b5998">
                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                  <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-facebook-f"></use>
                  </svg>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card" style="--cui-card-cap-bg: #00aced">
                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                  <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-twitter"></use>
                  </svg>
                  <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card" style="--cui-card-cap-bg: #4875b4">
                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                  <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-linkedin"></use>
                  </svg>
                  <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="progress-group mb-5">
                        <div class="progress-group-header">
                          <svg class="icon icon-lg me-2">
                            <use xlink:href="/tamplate/vendors/@coreui/icons/svg/free.svg#cil-user-female"></use>
                          </svg>
                          <div>Female</div>
                      ...
                      <div class="progress-group">
                        <div class="progress-group-header">
                          <svg class="icon icon-lg me-2">
                            <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-google"></use>
                          </svg>
                      ...
                      <thead class="fw-semibold text-nowrap">
                        <tr class="align-middle">
                          <th class="bg-body-secondary text-center">
                            <svg class="icon">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/free.svg#cil-people"></use>
                            </svg>
                          </th>
                      ...
                      <tbody>
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="/tamplate/assets/img/avatars/1.jpg" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/flag.svg#cif-us"></use>
                            </svg>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard"></use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="/tamplate/assets/img/avatars/2.jpg" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/flag.svg#cif-br"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-cc-visa"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="/tamplate/assets/img/avatars/3.jpg" alt="user@email.com"><span class="avatar-status bg-warning"></span></div>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/flag.svg#cif-in"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="/tamplate/assets/img/avatars/4.jpg" alt="user@email.com"><span class="avatar-status bg-secondary"></span></div>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/flag.svg#cif-fr"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="/tamplate/assets/img/avatars/5.jpg" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/flag.svg#cif-es"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="/tamplate/assets/img/avatars/6.jpg" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/flag.svg#cif-pl"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="/tamplate/vendors/@coreui/icons/svg/brand.svg#cib-cc-amex"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
            ...
            <table class="table table-bordered table-striped">
                <thead class="table-dark">
                    <tr style="text-align: center">
                        ...
                        <th>Subjek</th>
                        <th>Pesan</th>
                        <th style="width: 150px">Dikirim Pada</th>
                        <th>Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($contactinputs as $contact)
                        <tr>
                            <td>{{ $contact->name }}</td>
                            <td>{{ $contact->email }}</td>
                            ...
                            <td>
                                ...
                                <form action="{{ route('dashboard.destroy', $contact->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
